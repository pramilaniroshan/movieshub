...
const page = () => {
  return (
    <div className="container py-20">
      ...
      <p className="mt-0 whitespace-break-spaces">
        {`
Welcome to our website located at http://www.thetvdb.com (the “Site”), along with the services provided alongside the Site (the “Services”). The Services are operated by Whip Networks, Inc. and/or its corporate affiliates ("we," "us" and "our") and allow you to: (a) participate in interactive features that we may make available from time to time through the Site; (b) If authorized, access the TVDB Application Program Interface (”API”) for metadata relating to television and film content (the “Data”); (c) upload data to the Site; or (d) simply view this Site (collectively, the "Services"). These Terms of Service form an agreement that governs your permitted use of the Site and the Services (this "Agreement"). 
...
Obligations. If you supply Contributions to the Site or Services, you are entirely responsible for your Contributions to the Services. If you receive a credit toward a Subscription or other complimentary access to the Services in exchange for your Contributions, you acknowledge that we have no continuing obligation to provide any such benefits beyond what has been committed to you in writing, and you may be required to pay for access in the future. When you create or make available a Contribution, you represent and warrant that you:
...
Content on this Site ("Content"), along with trademarks, service marks, and logos contained on this Site ("Marks''), is owned by or licensed to us and is subject to Intellectual Property Rights under United States and foreign laws and international conventions. As between you and us, we own all worldwide right, title and interest in and to the Services, API and the Data, and any and all Intellectual Property Rights embodied therein or related thereto. You agree not to do anything inconsistent with such ownership. Permission to use content or materials for your Product beyond the API and Data (including for images) must be sought from the appropriate content owner. We reserve all rights not expressly granted in and to the Services, the API, and the Content. You agree that you will not circumvent, disable or otherwise interfere with security related features of the API or this Site. You further agree not to access this Site by any means other than through the interface that we provide, unless otherwise specifically authorized by us in writing. There are no implied rights, and we reserve all rights not expressly granted under these Terms. “Intellectual Property Rights'' as used in these Terms, means any and all patents, copyrights, trademarks, trade secrets and any other form of intellectual property rights recognized in any jurisdiction, including associated applications and registrations, and all associated moral rights. 

6. SUBSCRIPTION SERVICES

Certain features of the Services may require a subscription which may be charged in advance or periodically (the “Subscription Services”). For all Subscription Services, we will charge your payment method through our payment processor. If you purchase Subscription Services, you agree that your subscription is personal to you, and you may not share your account, password, or PIN with others. Any such sharing is a violation of these Terms of Service and may result in the cancellation of your subscription without refund. Most subscriptions will automatically renew at the end of the subscription period with a charge to the credit card that our payment processor has on file for you. You will be notified in advance of that renewal. For all subscription plans, if you do not wish your subscription to renew, you may cancel at any time through your account. We will not refund any unused or inadvertently renewed subscriptions, and it is always within our sole discretion whether to grant any refunds. 

Payment. When you pay for a subscription, our payment processor will take your credit card or other payment information and billing address and will collect and use such information in accordance with its Privacy Policy. If your designated payment method is refused or returned, you acknowledge that we may immediately cancel your subscription. Prices and payments are in United States currency only, and you are responsible for paying any applicable taxes on the subscription, unless stated otherwise. We reserve the right to change fees and any new subscription fees will apply after the end of your current subscription period.
...
Counter-Notices. If you believe that User Content or Contributions that has been removed from the Service is not infringing, or that you have the authorization from the copyright owner, the copyright owner's agent, or pursuant to the law, to post and use the material in your User Content or Contributions, you may send a counter-notice containing the following information to our copyright agent using the contact information set forth above:
...
IN NO EVENT SHALL WE BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY INDIRECT, CONSEQUENTIAL, INCIDENTAL, SPECIAL OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT DAMAGES ARISING FROM YOUR USE OF THIS SERVICES, CONTRIBUTIONS, MATERIALS OR ANY OTHER CONTENT THEREIN. NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED IN THESE TERMS OF SERVICE, OUR LIABILITY TO YOU IN RESPECT OF ANY LOSS OR DAMAGE SUFFERED BY YOU AND ARISING OUT OF OR IN CONNECTION WITH THE SERVICES, WHETHER IN CONTRACT, TORT OR FOR BREACH OF STATUTORY DUTY OR IN ANY OTHER WAY SHALL NOT EXCEED $500.

15. INDEMNITY

You agree to indemnify and hold us, our affiliates, licensees and licensors and our and their respective officers, directors, agents, partners and employees, harmless from any loss, liability, claim, or demand, including reasonable attorneys’ fees, made by any third party due to or arising out of the Contributions or Content you post to the Services, your use of the Services, the API, the Contributions, or Materials in violation of these Terms of Service and/or arising from a breach by you of these Terms of Service and/or any breach of your representations and warranties set forth above.

16. MISCELLANEOUS

Entire Agreement. These Terms of Service (and our Privacy Policy) constitute the entire agreement between you and us regarding the use of this Site and the Services and supersedes any prior or contemporaneous understandings, terms and agreements between you and us related to the subject matter hereof.
...
No Third Party Beneficiaries. These Terms of Service are between you and us. There are no third-party beneficiaries.

Section Titles. The section titles are for convenience only and have no legal or contractual effect.

Non-Waiver. Our failure to exercise or enforce any right or provision of these Terms of Service shall not operate as a waiver of such right or provision.
...
Any notice to be sent to you under this Agreement may be sent via your account or by email, post, or any other reasonable means, at the contact information provided by you. It is your obligation to insure that this information is current.

This Agreement was last updated on: October 23, 2020.
                `}
      </p>
    </div>
  );
